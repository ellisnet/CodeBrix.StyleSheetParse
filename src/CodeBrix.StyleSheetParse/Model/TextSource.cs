...
/// <summary>Represents a CSS text source.</summary>
public sealed class TextSource : IDisposable
{
    ...
    /// <summary>Initializes a new instance of the <see cref="TextSource"/> class.</summary>
    ...
    /// <summary>The current encoding member.</summary>
    ...
    /// <summary>Performs the read character operation.</summary>
    ...
    /// <summary>Performs the read characters operation.</summary>
    ...
    /// <summary>Performs the prefetch all async operation.</summary>
