...
public sealed class Url : IEquatable<Url>
{
    ...
    /// <summary>Performs the uri operation.</summary>
    ...
    /// <summary>Performs the convert operation.</summary>
    public static Url Convert(Uri uri)
    {
        return new(uri.OriginalString);
    }

    /// <summary>The origin member.</summary>
    ...
    /// <summary>Gets the is relative.</summary>
    ...
    /// <summary>The fragment member.</summary>
    ...
    /// <summary>The host member.</summary>
    public string Host
    {
    ...
    /// <summary>The host name member.</summary>
    ...
    /// <summary>The path member.</summary>
    public string Path
    {
        get => _path;
    ...
    /// <summary>The port member.</summary>
    public string Port
    {
        get => _port;
    ...
    /// <summary>The scheme member.</summary>
    ...
    /// <summary>The query member.</summary>
    public string Query
    {
        get => _query;
