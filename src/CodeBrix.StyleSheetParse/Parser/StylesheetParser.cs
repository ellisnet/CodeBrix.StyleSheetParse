...
/// <summary>Represents a CSS stylesheet parser.</summary>
public class StylesheetParser
{
    internal static readonly StylesheetParser Default = new();

    /// <summary>Initializes a new instance of the <see cref="StylesheetParser"/> class.</summary>
    ...
    /// <summary>Performs the parse async operation.</summary>
    ...
    /// <summary>Performs the parse selector operation.</summary>
