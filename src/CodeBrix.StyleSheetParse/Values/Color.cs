...
/// <summary>Represents a CSS color value.</summary>
...
public struct Color : IEquatable<Color>, IComparable<Color>, IFormattable
{
    ...
    /// <summary>Performs the from gray operation.</summary>
    ...
    /// <summary>Performs the from hex operation.</summary>
    ...
    /// <summary>Performs the try from hex operation.</summary>
    ...
    /// <summary>Performs the from flex hex operation.</summary>
    ...
    /// <summary>Performs the from hwb operation.</summary>
    public static Color FromHwb(float hue, float whiteness, float blackness)
    {
        return FromHwba(hue, whiteness, blackness, 1f);
    }

    /// <summary>Performs the from hwba operation.</summary>
    ...
    /// <summary>Performs the mix operation.</summary>
