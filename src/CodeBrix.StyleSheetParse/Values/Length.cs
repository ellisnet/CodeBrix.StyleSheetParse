...
/// <summary>Represents a CSS length value.</summary>
public struct Length : IEquatable<Length>, IComparable<Length>, IFormattable
{
    ...
    /// <summary>Performs the to pixel operation.</summary>
    ...
    public enum Unit : byte
    {
        ...
        None,
        /// <summary>The px value.</summary>
        Px,
        /// <summary>The em value.</summary>
        Em,
        /// <summary>The ex value.</summary>
        Ex,
        /// <summary>The cm value.</summary>
        Cm,
        /// <summary>The mm value.</summary>
        Mm,
        /// <summary>The in value.</summary>
        In,
        /// <summary>The pt value.</summary>
        Pt,
        /// <summary>The pc value.</summary>
        Pc,
        /// <summary>The ch value.</summary>
        Ch,
        /// <summary>The rem value.</summary>
        Rem,
        /// <summary>The vw value.</summary>
        Vw,
        /// <summary>The vh value.</summary>
        Vh,
        /// <summary>The vmin value.</summary>
        Vmin,
        /// <summary>The vmax value.</summary>
        Vmax,
