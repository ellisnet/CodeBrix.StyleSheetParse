...
public class RealWorld
{
	...
	public void ParseCss_WithStandardString_ExpectReadableProperties()
	{
		...
		// var info = stylesheet.Children.First(c => ((CodeBrix.StyleSheetParse.StyleRule)c).SelectorText == "html") as CodeBrix.StyleSheetParse.StyleRule;
		// var selector = info.SelectorText;
		// var firstCssProperty = info.Style.BackgroundColor;

		// Get the info out - New way
		var info = stylesheet.StyleRules.First() as CodeBrix.StyleSheetParse.StyleRule;
		var selector = info.SelectorText;
	...
	public void CreateStylesheet_WithCssProperties_ExpectStandardStringBack()
	{
		...
		var newParser = new CodeBrix.StyleSheetParse.StylesheetParser();

		CodeBrix.StyleSheetParse.StyleRule r = new CodeBrix.StyleSheetParse.StyleRule(newParser);
		r.SelectorText = "h1";
		r.Style.BackgroundColor = "red";

		CodeBrix.StyleSheetParse.StyleRule r2 = new CodeBrix.StyleSheetParse.StyleRule(newParser);
		r2.SelectorText = "h2";
